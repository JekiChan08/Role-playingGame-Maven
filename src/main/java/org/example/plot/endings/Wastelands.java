...
public class Wastelands {
    ...
    public Wastelands() {
        ...
        enemies.add(Enemies.PERSON);
        enemies.add(Enemies.ORC);
        enemies.add(Enemies.DWARF);
    ...
    public void start(MainHero mainHero) {
        ...
        System.out.println("Вы продите по пустоши в поийсках еды");
        boolean inWastelands = true;

        while (inWastelands) {
            if (level <= enemies.size()) {
                System.out.println("Текущий уровень Пустоши: " + level);
                switch (choiceWastelands()) {
            ...
            try {
                ...
                switch (choice) {
                    case 1 -> {
                        ...
                        if (enemyHealth <= 0) {
                            System.out.println(enemy.getName() + " был повержен!");
    ...
    public void battleOfBoss(MainHero mainHero) {
        ...
        System.out.println("Вы встретили злейшего врага Орков: " + boss.getName());
